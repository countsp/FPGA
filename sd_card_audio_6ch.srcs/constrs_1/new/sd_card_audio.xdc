...
set_property IOSTANDARD LVCMOS33 [get_ports {ccclk}]
set_property IOSTANDARD LVCMOS33 [get_ports {lrc}]

set_property PACKAGE_PIN AF20 [get_ports {dacdat}]
set_property PACKAGE_PIN AF21 [get_ports {ccclk}]
set_property PACKAGE_PIN AH22 [get_ports {lrc}]
