...
(
	...
	input[15:0]                      left_data,    //left channel audio data,ws_lrc = 1
	input[15:0]                      right_data,   //right channel audio data,ws_lrc = 0
...
reg[15:0]                            left_data_shift; //left channel audio data shift register
reg[15:0]                            right_data_shift;//right channel audio data shift register
...
begin
	if(rst == 1'b1)
		...
		sdata <= left_data_shift[15];
	else if(ws_lrc_d1 == 1'b0)
		sdata <= right_data_shift[15];
end
