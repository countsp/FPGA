...
wire[15:0]       tx_left_data;                //left channel audio data
wire[15:0]       tx_right_data;               //right channel audio data
wire             sd_init_done;                //SD card initialization completed

assign tx_left_data = {read_data[23:16],read_data[31:24]};
assign tx_right_data = {read_data[7:0],read_data[15:8]};
