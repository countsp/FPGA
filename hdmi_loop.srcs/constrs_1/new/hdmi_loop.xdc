...
create_clock -period 3.333 -name vin1_clk -waveform {0.000 1.667} [get_ports vin1_clk]
create_clock -period 3.333 -name vin2_clk -waveform {0.000 1.667} [get_ports vin2_clk]
